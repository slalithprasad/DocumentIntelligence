...
namespace DocumentIntelligence.Business.Services
{
    public class OpenAiservice : IOpenAIService
    {
        ...
        public async Task<ExtractionResponse> ExtractAsync(ExtractRequest? request)
        {
            ...
            string translationText = extractLanguage.Equals("english") ? "" : $"Extract all values for the specified keys in {extractLanguage}, and if any values are missing in {extractLanguage} but available in English, translate them—including documentType—to {extractLanguage}.";
